...
async def help_commands(message:Message):
    await message.answer("Salom siz botga inglizcha so'zyozing bot sizga buni o'qib beradi")
...
async def about_commands(message:Message):
    await message.answer("Men Qoxorov Shoxrux bu botni 06.04.2024 kuni SIFAT o'quv makazida yaratdim")
